...
$art2Content = @"
<p class="lead-text">Hacerte un <a href="../alisados.html">Alisado Saludable Orgánico</a> es una inversión en tu tiempo y tu belleza. Para garantizar que tu cabello se mantenga tan liso, brillante y sedoso como el primer día, es fundamental adoptar una rutina de mantenimiento adecuada en casa.</p><h2 id="lavado-correcto">1. El arte del lavado: Frecuencia y productos</h2><p>Lavar el cabello a diario elimina los aceites naturales y descompone progresivamente los aminoácidos depositados en la fibra. Se recomienda lavar el cabello 2 a 3 veces por semana utilizando un <a href="../linea-cuidado.html">Shampoo Libre de Sal y Sulfatos</a> de Julie Alisados.</p><h2 id="secado-termoactivo">2. Secado inteligente: Activación por calor</h2><p>Nuestras fórmulas son <strong>termoactivas</strong>. Esto significa que al recibir calor suave se alinean las cutículas memorizando la estructura lisa. Seca siempre el aire dirigiéndolo de arriba hacia abajo.</p><h2 id="nutricion-semanal">3. Nutrición e hidratación profunda</h2><p>Aplica una vez por semana la <a href="../linea-cuidado.html">Mascarilla de Oro Reparadora</a> de Julie Alisados durante 15 a 20 minutos para reponer la masa proteica perdida por factores ambientales.</p>
"@
...
Write-Host "✅ articles.json reconstruido perfectamente en UTF-8 puro sin BOM."
