# Script con UTF-8 BOM para forzar a PowerShell 5.1 a interpretar caracteres en UTF-8
...
# Corregir exactamente las palabras acentuadas en el artículo 1
  ...
  <table style="width: 100%; border-collapse: collapse; text-align: left;">
    <thead>
      <tr style="background: var(--gold-dark); color: white;">
        ...
        <th style="padding: 12px;">Duración Estimada</th>
...
<h2 id="conclusion">Conclusión y Asesoría Personalizada</h2>
